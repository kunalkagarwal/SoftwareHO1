...
//Q.Write a program to execute ls -Rl using execl

#include <unistd.h>//required for the excel system call
#include <stdio.h>// included to use perror

int main() {
    // This will execute the 'ls -Rl' command using execl
    if (execl("/bin/ls", "ls", "-Rl", (char *)0) == -1) {
        // "/bin/ls" is the path to the ls executable
        // "ls" program name
        //'ls -Rl' this is the options passed to ls
        //The final arguement is a null pointer
...
/*Output:
kunalagarwal@Kunals-MacBook-Air software systems handson 1 % cc 27a.c
...
-rw-r--r--@ 1 kunalagarwal  staff    674 Aug 31 00:18 27c.c
...
-rwxr-xr-x@ 1 kunalagarwal  staff  33464 Aug 31 15:34 a.out
