...
//Q27d Write a program to execute ls -Rl using execv
...
int main() {
    ...
    // This array holds the arguements to be passed to the execv function
    execv("/bin/ls", args);
    //The execv function replaces the current process image with a new process image specified by the path.
    //int execv(const char *path, char *const argv[]);
    //here the path must be absolute
    // An array of pointers to null-terminated strings representing the arguments to the program. 
    
    perror("execv failed");
    return 1;
}

/*kunalagarwal@Kunals-MacBook-Air software systems handson 1 % cc 27d.c
...
-rwxr-xr-x@ 1 kunalagarwal  staff  33592 Aug 31 15:38 a.out
